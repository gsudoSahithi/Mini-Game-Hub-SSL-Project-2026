...
\item{Showing the statistics,top5 player and their win count using bar graph and games and their frequency using pie chart by using matplotlib\cite{iitb_matlplotlib}}
\end{itemize}
\section{Code Logic}
